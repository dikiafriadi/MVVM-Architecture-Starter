...
public class MainActivity extends BaseActivity<ActivityMainBinding, MainViewModel> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.searchBar.searchText.setText(usernameSaved); /* setup RecyclerView*/
    ...
    public void updateUI() {
        ...
        YoYo.with(Techniques.SlideInUp).duration(1000).playOn(binding.toolbarContainer.ivSelfie);/* set Data*/
    ...
    private void showCategory() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(this).setTitle("Category").setSingleChoiceItems(CAT, 0, (dialogInterface, i) -> selectCategory = CAT[i]).setPositiveButton("Ok", (dialogInterface, i) -> binding.searchBar.category.setText(selectCategory)).setNegativeButton("Cancel", null);
        builder.show();
    }
}